...
/* ==== this page contains delegationPage and delegationDialog Views ==== */
    ...
    initialize: function(props) {
      ...
      Q.all([
        ...
        .then(function(results) {
          ...
          console.log(processListView.el);
